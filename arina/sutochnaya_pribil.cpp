...
private:
    ...
    vector<CookieLine> lines; // Вектор для хранения линий
...
public:
    ...
    void printProductionInfo() const
    {
        ...
        cout << endl;
        cout << "Информация о производстве печенья:" << endl;
...
int main()
{
    ...
    cout << "Введите процент прибыли при выполнении плана: ";
    cin >> profitMet;
    cout << "Введите процент прибыли при недовыполнении плана: ";
    cin >> profitUnder;
    cout << "Введите процент прибыли при перевыполнении плана: ";
    cin >> profitOver;
